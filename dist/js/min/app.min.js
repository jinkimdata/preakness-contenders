...
this.indicatorStyle.width=this.width+"px",t=this.maxPosX+this.indicatorWidth-this.width):t=this.maxBoundaryX:"scale"==this.options.shrink&&this.width!=this.indicatorWidth&&(this.width=this.indicatorWidth,this.indicatorStyle.width=this.width+"px"),i<this.minBoundaryY?("scale"==this.options.shrink&&(this.height=s.max(this.indicatorHeight+3*i,8),this.indicatorStyle.height=this.height+"px"),i=this.minBoundaryY):i>this.maxBoundaryY?"scale"==this.options.shrink?(this.height=s.max(this.indicatorHeight-3*(i-this.maxPosY),8),this.indicatorStyle.height=this.height+"px",i=this.maxPosY+this.indicatorHeight-this.height):i=this.maxBoundaryY:"scale"==this.options.shrink&&this.height!=this.indicatorHeight&&(this.height=this.indicatorHeight,this.indicatorStyle.height=this.height+"px")),this.x=t,this.y=i,this.scroller.options.useTransform?this.indicatorStyle[h.style.transform]="translate("+t+"px,"+i+"px)"+this.scroller.translateZ:(this.indicatorStyle.left=t+"px",this.indicatorStyle.top=i+"px")},_pos:function(t,i){0>t?t=0:t>this.maxPosX&&(t=this.maxPosX),0>i?i=0:i>this.maxPosY&&(i=this.maxPosY),t=this.options.listenX?s.round(t/this.sizeRatioX):this.scroller.x,i=this.options.listenY?s.round(i/this.sizeRatioY):this.scroller.y,this.scroller.scrollTo(t,i)},fade:function(t,i){if(!i||this.visible){clearTimeout(this.fadeTimeout),this.fadeTimeout=null;var s=t?250:500,e=t?0:300;t=t?"1":"0",this.wrapperStyle[h.style.transitionDuration]=s+"ms",this.fadeTimeout=setTimeout(function(t){this.wrapperStyle.opacity=t,this.visible=+t}.bind(this,t),e)}}},e.utils=h,"undefined"!=typeof module&&module.exports?module.exports=e:"function"==typeof define&&define.amd?define(function(){return e}):t.IScroll=e}(window,document,Math);var preaknessContenders={init:function(){preaknessContenders.scrollFuntions()},share:function(){$(".icon-twitter").on("click",function(){var t="",i="",s="https://twitter.com/intent/tweet?text="+t+"&url="+i+"&tw_p=tweetbutton";return window.open(s,"mywin","left=200,top=200,width=500,height=300,toolbar=1,resizable=0"),!1}),$(".icon-facebook").on("click",function(){var t="",i="",s="",e="",o="https://www.facebook.com/dialog/feed?display=popup&app_id=310302989040998&link="+e+"&picture="+t+"&name="+i+"&description="+s+"&redirect_uri=http://www.facebook.com";return window.open(o,"mywin","left=200,top=200,width=500,height=300,toolbar=1,resizable=0"),!1})},scrollFuntions:function(){function t(){var t=i.getComputedPosition(),s=Math.abs(t.y),e=$(window).height()-50;s>e?($("#sticky").addClass("stick"),$("#sticky-anchor").height($("#sticky").outerHeight())):($("#sticky").removeClass("stick"),$("#sticky-anchor").height(0));var o=Math.abs(t.x),n=$(window).width(),r=Math.round(o/n);$(".posMarker").removeClass("posMarker"),$(".fa-circle--"+r).addClass("posMarker")}var i=new IScroll("#contenders",{scrollX:!0,scrollY:!0,momentum:!1,snap:!0,mouseWheel:!0,probeType:3});document.addEventListener("touchend",function(t){t.preventDefault()},!1),i.on("scroll",function(){t()}),$(".backToTop").on("click touchend",function(){var t=i.getComputedPosition(),s=Math.abs(t.x),e=$(window).width(),o=Math.round(s/e);console.log(o),i.goToPage(o,0)})}};$(document).ready(function(){preaknessContenders.init(),console.log("connected")});