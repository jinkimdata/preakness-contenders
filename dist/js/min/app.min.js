...
this.indicatorStyle.width=this.width+"px",t=this.maxPosX+this.indicatorWidth-this.width):t=this.maxBoundaryX:"scale"==this.options.shrink&&this.width!=this.indicatorWidth&&(this.width=this.indicatorWidth,this.indicatorStyle.width=this.width+"px"),i<this.minBoundaryY?("scale"==this.options.shrink&&(this.height=e.max(this.indicatorHeight+3*i,8),this.indicatorStyle.height=this.height+"px"),i=this.minBoundaryY):i>this.maxBoundaryY?"scale"==this.options.shrink?(this.height=e.max(this.indicatorHeight-3*(i-this.maxPosY),8),this.indicatorStyle.height=this.height+"px",i=this.maxPosY+this.indicatorHeight-this.height):i=this.maxBoundaryY:"scale"==this.options.shrink&&this.height!=this.indicatorHeight&&(this.height=this.indicatorHeight,this.indicatorStyle.height=this.height+"px")),this.x=t,this.y=i,this.scroller.options.useTransform?this.indicatorStyle[h.style.transform]="translate("+t+"px,"+i+"px)"+this.scroller.translateZ:(this.indicatorStyle.left=t+"px",this.indicatorStyle.top=i+"px")},_pos:function(t,i){0>t?t=0:t>this.maxPosX&&(t=this.maxPosX),0>i?i=0:i>this.maxPosY&&(i=this.maxPosY),t=this.options.listenX?e.round(t/this.sizeRatioX):this.scroller.x,i=this.options.listenY?e.round(i/this.sizeRatioY):this.scroller.y,this.scroller.scrollTo(t,i)},fade:function(t,i){if(!i||this.visible){clearTimeout(this.fadeTimeout),this.fadeTimeout=null;var e=t?250:500,s=t?0:300;t=t?"1":"0",this.wrapperStyle[h.style.transitionDuration]=e+"ms",this.fadeTimeout=setTimeout(function(t){this.wrapperStyle.opacity=t,this.visible=+t}.bind(this,t),s)}}},s.utils=h,"undefined"!=typeof module&&module.exports?module.exports=s:"function"==typeof define&&define.amd?define(function(){return s}):t.IScroll=s}(window,document,Math);var preaknessContenders={init:function(){preaknessContenders.scrollFunctions()},share:function(){$(".icon-twitter").on("click",function(){var t="",i="",e="https://twitter.com/intent/tweet?text="+t+"&url="+i+"&tw_p=tweetbutton";return window.open(e,"mywin","left=200,top=200,width=500,height=300,toolbar=1,resizable=0"),!1}),$(".icon-facebook").on("click",function(){var t="",i="",e="",s="",o="https://www.facebook.com/dialog/feed?display=popup&app_id=310302989040998&link="+s+"&picture="+t+"&name="+i+"&description="+e+"&redirect_uri=http://www.facebook.com";return window.open(o,"mywin","left=200,top=200,width=500,height=300,toolbar=1,resizable=0"),!1})},scrollFunctions:function(){function t(){i.currentPage.pageY>0?($("#sticky").addClass("stick"),$("#sticky-anchor").height($("#sticky").outerHeight())):($("#sticky").removeClass("stick"),$("#sticky-anchor").height(0))}var i=new IScroll("#contenders",{scrollX:!0,scrollY:!0,momentum:!1,snap:!0,mouseWheel:!0,disableMouse:!0,probeType:3,bounce:!1});document.addEventListener("touchend",function(t){t.preventDefault()},!1);var e;i.on("scroll",function(){e&&clearTimeout(e),e=setTimeout(function(){t()},100)}),$(".fa-angle-left").on("click touchend",function(t){e&&clearTimeout(e),e=setTimeout(function(){i.currentPage.pageX>0?i.goToPage(i.currentPage.pageX-1,i.currentPage.pageY):0==i.currentPage.pageX&&i.goToPage(7,i.currentPage.pageY)},50)}),$(".fa-angle-right").on("click touchend",function(t){e&&clearTimeout(e),e=setTimeout(function(){i.currentPage.pageX<7?i.goToPage(i.currentPage.pageX+1,i.currentPage.pageY):7==i.currentPage.pageX&&i.goToPage(0,i.currentPage.pageY)},50)}),$(".fa-angle-up").on("click touchend",function(t){e&&clearTimeout(e),e=setTimeout(function(){i.goToPage(i.currentPage.pageX,i.currentPage.pageY-1)},50)}),$(".fa-angle-down").on("click touchend",function(t){e&&clearTimeout(e),e=setTimeout(function(){i.goToPage(i.currentPage.pageX,i.currentPage.pageY+1)},50)}),$(".backToTop").on("click touchend",function(t){e&&clearTimeout(e),e=setTimeout(function(){i.goToPage(i.currentPage.pageX,0)},50)}),$(".navBlock").on("click",function(t){var s=$(this),o=Number(s.attr("data-pos"));e&&clearTimeout(e),e=setTimeout(function(){i.goToPage(i.currentPage.pageX,o)},50)}),i.on("scrollEnd",function(){$(".selected").removeClass("selected"),$(".navBlock--"+i.currentPage.pageY).addClass("selected")})}};$(document).ready(function(){preaknessContenders.init(),console.log("connected")});